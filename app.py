...
<head>
    ...
    <style>
        ...
        /* 🔥 TRUCO MAESTRO: Esconde el fondo circular negro original y proyecta solo las compuertas blancas de forma 100% transparente */
        ...
        .bts-logo-clean {{
            ...
            height: 50px;
            object-contain: fit;
            filter: drop-shadow(100px 0px 0px rgba(255, 255, 255, 0.95));
        }}
    </style>
</head>
        ...
        <header class="flex flex-col md:flex-row md:justify-between md:items-center border-b border-zinc-800 pb-6 mb-8 gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="transparent-logo-container">
                    <img src="https://e7.pngegg.com/pngimages/932/472/png-clipart-bts-logo-k-pop-design-bts-logo-angle-white-thumbnail.png" alt="BTS Logo" class="bts-logo-clean">
                </div>
